...
export const queryKey = "RetrieveAllDocumentTemplatesAndDocumentsForRelatedTableRecordByPublicAccess";

export const retrieveAllDocumentTemplatesAndDocumentsForRelatedTableRecordByPublicAccess = async (
  ...
  return await requestClient({ userAuth, baseUrl }).get<QueryParams, PathParams>(
    {
      path: apiPaths.document.retrieveAllDocumentTemplatesAndDocumentsForRelatedTableRecordByPublicAccess,
      queryParams,
      pathParams,
    },
    requestOptionsInit
...
export const useRetrieveAllDocumentTemplatesAndDocumentsForRelatedTableRecordByPublicAccess = (params: Params, options?: UseQueryOptions<Response, Error>, requestOptionsInit?: RequestOptionsInit) => {
