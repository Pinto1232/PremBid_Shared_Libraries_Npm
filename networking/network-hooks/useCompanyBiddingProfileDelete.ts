...
export const mutationKey = ["CompanyBiddingProfileDelete"];

export const companyBiddingProfileDelete = async (params: Params, { userAuth, baseUrl }: RequestConfig, requestOptionsInit?: RequestOptionsInit): Promise<Response> => {
  return await requestClient({ userAuth, baseUrl }).post<Params>(
    {
      path: apiPaths.profile.CompanyBiddingProfileDelete,
      payload: params,
    },
    requestOptionsInit
  );
...
export const useCompanyBiddingProfileDelete = (options?: UseMutationOptions<Response, Error, Params>, requestOptionsInit?: RequestOptionsInit) => {
  ...
  const mutation = useMutation({
    mutationFn: (params: Params) => companyBiddingProfileDelete(params, { userAuth, baseUrl }, requestOptionsInit),
    mutationKey,
    meta: {
      createdAt: Date.now(),
    },
