...
import { RegisteredAuctionUser } from "../../types";
...
type Response = RegisteredAuctionUser[];
...
export const queryKey = "RetrieveAllRegisteredUsersByAuctionId";

export const retrieveAllRegisteredUsersByAuctionId = async (
  { queryParams, pathParams }: Params = {},
  { userAuth, baseUrl }: RequestConfig,
  requestOptionsInit?: RequestOptionsInit
): Promise<Response> => {
  return await requestClient({ userAuth, baseUrl }).get<QueryParams, PathParams>({ path: apiPaths.user.retrieveAllRegisterdUsersByAuctionId, queryParams, pathParams }, requestOptionsInit);
};

export const useRetrieveAllRegisteredUsersByAuctionId = (params: Params, options?: UseQueryOptions<Response, Error>, requestOptionsInit?: RequestOptionsInit) => {
