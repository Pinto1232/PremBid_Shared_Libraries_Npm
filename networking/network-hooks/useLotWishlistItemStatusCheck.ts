...
type PathParams = { profileId: string; lotId: string };

export type Params = QueryArgs<QueryParams, PathParams>;

export const queryKey = "LotWishlistItemStatusCheck";

export const lotWishlistItemStatusCheck = async ({ queryParams, pathParams }: Params = {}, { userAuth, baseUrl }: RequestConfig, requestOptionsInit?: RequestOptionsInit): Promise<Response> => {
  return await requestClient({ userAuth, baseUrl }).get<QueryParams, PathParams>({ path: apiPaths.lotWishlist.lotWishlistItemStatusCheck, queryParams, pathParams }, requestOptionsInit);
};

export const useLotWishlistItemStatusCheck = (params: Params, options?: UseQueryOptions<Response, Error>, requestOptionsInit?: RequestOptionsInit) => {
